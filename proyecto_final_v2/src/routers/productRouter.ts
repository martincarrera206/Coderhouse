...
import ContenedorArchivo from '../containers/ContenedorArchivos'
import ContenedorMySQL from '../containers/ContenedorMysql'

const contenedorArchivoProducto = new ContenedorArchivo('./src/data/products.json')
...
productRouter.get('/api/productos', (request:Request, response:Response, next:NextFunction) => {
    ...
    ;( async (_response:Response) => {
        const productos = await contenedorArchivoProducto.getAll()
...
productRouter.get('/api/productos/:id', (request:Request, response:Response, next:NextFunction) => {
    ...
    ;( async (_request:Request ,_response:Response) => {
        ...
        const producto = await contenedorArchivoProducto.getById(product_id)
